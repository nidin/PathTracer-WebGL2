...
export class BVHNode {
    constructor(public bbox: BBox=new BBox(), public isLeaf: boolean=false,
                public idLeft: number=-1, public idRight: number=-1,
                public idTriangle: number=-1,
                public idMiss: number=-1, public idBase: number=-1) {
